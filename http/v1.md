...
These requests include the [`asset_pairs`](#get-v1-asset-pairs), [`orders`](#get-v1-orders), and [`orderbook`](#get-v1-orderbook) endpoints.
...
Filter parameters:
  ...
  *   takerAssetProxyId [string]:  returns orders where the taker asset is of certain [asset proxy id](https://0xproject.com/docs/0x.js#types-AssetProxyId)(example: `ERC20`, `ERC721`)
