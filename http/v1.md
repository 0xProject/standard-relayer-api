...
*   [REST API](#rest-api)
    ...
    *   [GET order_config](#get-v1order_config)
    *   [GET fee_recipients](#get-v1-fee-recipients)
...
```
{
      ...
      "remainingFillableTakerAmount": "5000000000",
}
```
        ...
        "records": [
            {
                ...
                "remainingFillableTakerAmount": "50000000000",
            },
          ...
        ]  
    }
